...
public class UserVehiclesEditSheet(IState<bool> isOpen, RefreshToken refreshToken, int vehicleId) : ViewBase
{
    public override object? Build()
    {
        ...
        return vehicle
            ...
            .Remove(e => e.Id, e => e.CreatedAt, e => e.UpdatedAt, e => e.ManagerId, e => e.ErpSyncId)
