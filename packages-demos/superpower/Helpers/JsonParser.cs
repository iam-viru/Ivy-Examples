namespace SuperpowerExample.Helpers
{
    ...
    static class JsonTokenizer
    {
        ...
        static TextParser<Superpower.Model.Unit> JsonStringToken { get; } =
            from open in Character.EqualTo('"')
            from content in Character.EqualTo('\\').IgnoreThen(Character.AnyChar).Value(Superpower.Model.Unit.Value).Try()
                .Or(Character.Except('"').Value(Superpower.Model.Unit.Value))
                .IgnoreMany()
            from close in Character.EqualTo('"')
            select Superpower.Model.Unit.Value;
        ...
        static TextParser<Superpower.Model.Unit> JsonNumberToken { get; } =
